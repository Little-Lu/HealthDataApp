package com.joye.health.model.emergency;

public class HeTroopMemberRecord {
	...
	private String specialtySummarize;
	...
	public String getDutyLevelLevel() {
		return dutyLevelLevel;
	}

	public void setDutyLevelLevel(String dutyLevelLevel) {
		this.dutyLevelLevel = dutyLevelLevel;
	}
